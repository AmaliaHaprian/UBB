...
if repo_style == "memory":
    ...
    rental_service = RentalService(rental_repo, undo_service, book_repo, client_repo)
    book_service = BookService(book_repo, undo_service, rental_service)
    client_service = ClientService(client_repo, undo_service, rental_service)


    ui = UI(undo_service, book_service, client_service, rental_service)
