    ...
    for i in range(n):
        while True:
            try:
                ...
                numbers.append(create_number(real, imaginary))
                break
            except ValueError as ve:
                print("Real and imaginary parts should be integers")
...
def create_number(real, imaginary):
    if -100>real or real>100 or imaginary<-100 or imaginary>100:
        print('Real and Imaginary values must be between -100 and 100 but were given as ' + str(real) + ' and ' + str(imaginary))
