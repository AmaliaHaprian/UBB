...
void UserGui::initGui()
{
	...
	checkBoxLayout->addWidget(this->csvBox);
	checkBoxLayout->addWidget(this->htmlBox);
	mainLayout->addLayout(checkBoxLayout);

	QButtonGroup* group = new QButtonGroup(this);
	group->setExclusive(true);
	group->addButton(csvBox);
	group->addButton(htmlBox);
...
{
QObject::connect(csvBox, &QCheckBox::toggled, this->seeDogsButton, &QPushButton::setEnabled);
QObject::connect(csvBox, &QCheckBox::toggled, this->seeAdoptionListButton, &QPushButton::setEnabled);
QObject::connect(csvBox, &QCheckBox::toggled, this->searchBreed, &QPushButton::setEnabled);

QObject::connect(htmlBox, &QCheckBox::toggled, this->seeDogsButton, &QPushButton::setEnabled);
QObject::connect(htmlBox, &QCheckBox::toggled, this->seeAdoptionListButton, &QPushButton::setEnabled);
QObject::connect(htmlBox, &QCheckBox::toggled, this->searchBreed, &QPushButton::setEnabled);

QObject::connect(csvBox, &QCheckBox::checkStateChanged, [this](int state) {
	if (state == Qt::Checked) {
		this->adoptionListHandler(1);
	}
});

QObject::connect(htmlBox, &QCheckBox::checkStateChanged, [this](int state) {
	if (state == Qt::Checked) {
